...
public class WhatsOnActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new WhatsOnAdapter(LayoutInflater.from(this), eventSelectedListener, new CalendarSource(timeRepository, new SparseArray<CalendarItem>(), 0, new JodaTime(DateTime.now())));
