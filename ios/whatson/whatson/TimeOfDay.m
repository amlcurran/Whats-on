...
- (jlong)toMinutes {
  return [((JavaUtilConcurrentTimeUnitEnum *) nil_chk(JreLoadStatic(JavaUtilConcurrentTimeUnitEnum, MILLISECONDS))) toMinutesWithLong:millis_];
}
...
SCTimeOfDay *SCTimeOfDay_fromHoursWithInt_(jint hours) {
  ...
  return new_SCTimeOfDay_initWithLong_([((JavaUtilConcurrentTimeUnitEnum *) nil_chk(JreLoadStatic(JavaUtilConcurrentTimeUnitEnum, HOURS))) toMillisWithLong:hours]);
}
