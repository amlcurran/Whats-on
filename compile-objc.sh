...
echo '...transpilin'
j2objc --build-closure --dead-code-report usage.log -d build/ios/objc -sourcepath core/rxjava-1.0.13-sources.jar:./core/src/main/java/ `find core/src/main/java/ -name '*.java'`
echo
